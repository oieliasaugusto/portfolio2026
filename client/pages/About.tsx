...
<figure className="Logos w-full  flex items-center justify-center flex-row flex-wrap wrap gap-8">
...
<figure className="Logos w-full flex pb-0 items-center justify-center flex-row flex-wrap wrap gap-12">
