  ...
  return (
    <main ref={mainRef} id="viewProject" className="px-6 md:px-10 lg:px-14 xl:px-40 py-24 min-h-screen bg-black">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-12 project-info-grid">
        ...
        <div>
          <h3 className="text-xl font-light mb-2 text-[#ff5c35]">Desafio</h3>
        ...
        <div>
          <h3 className="text-xl font-light mb-2 text-[#ff5c35]">Resultado</h3>
          <p className="text-white/70 leading-relaxed">
      ...
      <section id="projectImages" className="project-images mt-12">
        <div className="overflow-hidden shadow-2xl text-center">

          <img src="/portfolio/kodie/KV_Academy.png" alt="KODIE Academy" className="w-full h-auto" />
          <h4>KV KODIE Academy</h4>
          <p>Representa talentos formados para conquistar o espaço de protagonistas do futuro no mercado de tecnologia.</p>

          <img src="/portfolio/kodie/KV_Studio.png" alt="KODIE Studio" className="w-full h-auto" />
          <h4>KV KODIE Studio</h4>
          <p>Talentos preparados para o mercado de trabalho, prontos para entregar soluções de tecnologia de alto nível e impacto.</p>
          ...
          <img src="/portfolio/kodie/Blusa_KODIE.jpeg" alt="Blusa KODIE" className="mx-auto object-cover w-[800px] h-[800px]" />
