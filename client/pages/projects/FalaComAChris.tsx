      ...
      <section id="projectImages" className="project-images mt-12">
        <div className="overflow-hidden shadow-2xl">
          ...
          <div className="bg-[#2170CC] rounded-3xl p-8 w-full grid grid-cols-1">
            <div className="flex flex-col lg:flex-row items-center pb-12 p-0 lg:p-4 gap-4 lg:gap-0 lg:p-8">
              <img src="/portfolio/ptchris/Screen1.png" alt="" className="h-auto !rounded-3xl max-h-auto lg:max-h-[650px] object-contain shadow-xl z-index-10" />
              <img src="/portfolio/ptchris/1Cadastro.svg" alt="" 
              className="bg-white lg:!rounded-none px-1 lg:px-24 py-4 w-full h-auto max-h-auto lg:max-h-[590px] object-contain z-index-10" />
              <img src="/portfolio/ptchris/Screen2.png" alt="" className="h-auto !rounded-3xl max-h-auto lg:max-h-[650px] object-contain shadow-xl z-index-10" />
            </div>

            <div className="flex flex-col lg:flex-row items-center gap-y-8 rounded-3xl bg-[#2170CC] pb-12 lg:p-8">
              <img src="/portfolio/ptchris/Screen3.png" alt="" className="h-auto max-h-auto !rounded-3xl lg:max-h-[650px] object-contain shadow-xl" />
              <img src="/portfolio/ptchris/2Contratacao.svg" alt="" className="bg-white p-24 w-full !rounded-none h-auto max-h-auto lg:max-h-[580px] object-contain" />
              <img src="/portfolio/ptchris/Screen3.png" alt="" className="h-auto max-h-auto !rounded-3xl lg:max-h-[650px] object-contain shadow-xl" />

            </div>

            <div className="flex flex-col lg:flex-row gap-4 rounded-3xl bg-[#2170CC] pb-12 lg:p-8">
              <img src="/portfolio/ptchris/Resumo.png" alt="" className="w-full h-auto max-h-auto lg:max-h-[650px] object-contain" />
              <img src="/portfolio/ptchris/Screen4.png" alt="" className="w-full h-auto max-h-auto lg:max-h-[650px] object-contain" />
              <img src="/portfolio/ptchris/Screen5.png" alt="" className="w-full h-auto max-h-auto lg:max-h-[650px] object-contain" />
              <img src="/portfolio/ptchris/Screen6.png" alt="" className="w-full h-auto max-h-auto lg:max-h-[650px] object-contain" />
            </div>

            <div className="flex flex-col lg:flex-row items-center justify-center w-full gap-y-4 lg:p-8">
              <img src="/portfolio/ptchris/3Atendimento.svg" alt="" className="lg:block hidden bg-white p-2 lg:p-24 w-full h-auto max-h-auto lg:max-h-[500px] object-contain" />
              <img src="/portfolio/ptchris/Screen7.png" alt="" 
              className="lg:relative top-0 right-20 h-auto max-h-auto lg:max-h-[650px] object-contain shadow-xl" />
            </div>
